...
<html>
	...
	<body>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="dowizard">
								<div class="row" style="padding:10px">
										...
										<div class="col-sm-3"><input name="name_audio" class="form-control" required="" type="text" placeholder="กรอกชื่อโสตทัศนวัสดุ" data-parsley-minlength="6"></input></div>
										<label class="col-sm-2 control-label" style="margin-left: 0px;">อ้างอิง</label>
										<div class="col-sm-3"><input name="ref_audio"  class="form-control" required="" type="text" placeholder="กรอกหนังสืออ้างอิง" data-parsley-minlength="6"></input></div>
								</div>
								<div class="row" style="padding:10px">
										<label class="col-sm-2 control-label" style="margin-left:40px;">จำนวนแผ่น</label>
										<div class="col-sm-3"><input name="amount_audio" class="form-control" required="" type="text" placeholder="กรอกจำนวน" data-parsley-minlength="6"></input></div>
										<label class="col-sm-2 control-label" style="margin-left: 0px;">ภาษา</label>
										<div class="col-sm-3"><input name="language_audio" class="form-control" required="" type="text" placeholder="กรอกภาษา" data-parsley-minlength="6"></input></div>
								</div>
								<div class="row">
			...
			<div class="col-xs-12" style="padding: 0px 15px 15px; pading: 10px;">
				<div class="panel panel-default">
					<div class="panel-heading" style="background-color:#00a29e">
						<h2 style="margin-top:5px; margin-bottom:5px;">รายการวารสาร</h2>
					</div>
