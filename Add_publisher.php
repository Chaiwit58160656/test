						...
						<div class="tab-content">
							<div class="tab-pane active" id="dowizard">
								<div class="row" style="padding:10px">
										...
										<div class="col-sm-4"><input name="name_audio" class="form-control" required="" type="text" placeholder="กรอกชชื่อสำนักพิมพ์" data-parsley-minlength="6"></input></div>
								</div>
								<div class="row" style="padding:10px">
										<label class="col-sm-2 control-label" style="margin-left:250px;">จังหวัด</label>
										<div class="col-sm-4"><input name="amount_audio" class="form-control" required="" type="text" placeholder="กรอกจังหวัด" data-parsley-minlength="6"></input></div>
								</div>
								<div class="row">
